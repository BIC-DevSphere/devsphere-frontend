...
import { CalendarCog, KanbanIcon, LayoutDashboardIcon, Settings, Tags, Users, Moon, Sun } from "lucide-react";
        ...
        {sidebarItems.slice(0, 3).map((item) => {
          ...
          return (
            <NavLink
              ...
              className={({ isActive }) =>
                `flex flex-col items-center justify-center gap-1.5 rounded-lg p-3 text-center transition-all duration-200 hover:bg-gray-100 dark:hover:bg-gray-800 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-500 ${isActive ? 'bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-300 shadow-sm' : 'text-gray-600 dark:text-gray-300'
                }`
              }
